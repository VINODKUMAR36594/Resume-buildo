...
featureCardHover: "absolute -inset-2 bg-gradient-to-r opacity-0 group-hover:opacity-100 transition-opacity rounded-3xl from-violet-200/40 to-fuchsia-200/40 shadow-[0_0_40px_rgba(168,85,247,0.6)]"
...
export const infoStyles = {
  ...
  // progressBar: `h-full rounded-full transition-all`, // Removed - unused
  ...
  // workDuration: progressBar => `text-sm font-bold italic`,
