...
import { Zap, Award, TrendingUp, Edit, Trash2, Clock, Check } from "lucide-react";
        ...
        <div className="relative w-full h-full overflow-hidden">
          ...
          {isSelected && (
            <div className="absolute inset-0 bg-violet-500/10 flex items-center justify-center">
              <div className="w-12 h-12 bg-white backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg animate-pulse">
